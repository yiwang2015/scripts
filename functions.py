...
def json_dumps_unicode_to_string(data,_indent=None):
    if _indent != None:
        return json.dumps(data,indent=int(_indent),object_hook=_decode_dict)
    return json.dumps(data,object_hook=_decode_dict)
